...
def graph_plotly_button():
    ...
    new_graph_data.save_to = current_config.save_to
    new_graph_data.graph_start = current_config.graph_start
    new_graph_data.graph_end = current_config.graph_end
    new_graph_data.datetime_offset = current_config.datetime_offset
    new_graph_data.sql_queries_skip = current_config.sql_queries_skip

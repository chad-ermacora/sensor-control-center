...
class CreateReportsWindow:
    ...
    def __init__(self, app, ip_selection, current_config):
        ...
        self.text1 = guizero.Text(self.window,
                                  text="Live Readings Report  |",
                                  color='blue',
                                  grid=[1, 6],
                                  align="top")

        self.button_check_sensor = guizero.PushButton(self.window,
                                                      text="Create",
                                                      command=self.app_sensor_readings_report,
                                                      grid=[1, 7],
                                                      align="top")

        self.text2 = guizero.Text(self.window,
                                  text="|  System Report  |",
                                  color='blue',
                                  grid=[2, 6],
                                  align="top")

        self.button_sensor_detail = guizero.PushButton(self.window,
                                                       text="Create",
        ...
        self.button_sensor_config = guizero.PushButton(self.window,
                                                       text="Create",
